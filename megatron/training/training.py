...
from ZeroGPU.Utils import assert_model_params_and_grads_are_zero, reset_model_and_optimizer_weights, reset_model_and_optimizer_grads, log_ZeroGPU, zero_a_and_check_model_b
...
def train_step(forward_step_func, data_iterator,
    ...
    if args.curr_iteration == ZeroGPU_FAILED_GPU_ITERATION:
        ...
        if ZeroGPU_TEST_MODE and torch.distributed.get_rank() == ZeroGPU_FAILED_GPU_NUMBER:
